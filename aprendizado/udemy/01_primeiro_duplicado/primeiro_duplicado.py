...
tabela = PrettyTable(['LISTA', 'PRIMEIRO DUPLICADO'])


def func_duplicados(lista):
    lista_unicos = set()
...
for lista_interna in lista_de_listas_de_inteiros:
    duplicado = func_duplicados(lista_interna)
    tabela.add_row([lista_interna, duplicado])
